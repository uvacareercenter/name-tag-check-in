...
export default function Display({ open, setOpen }) {
  ...
  return (
    <Dialog open={open} onClose={() => setOpen(false)} fullScreen>
      <Title name={"EMPLOYERS"} classes={styles.title}/>
      <Box sx={styles.sectionsWrapper}>
        {isSponsoredEvent && (
          <>
            <Header name={"Sponsors at Today's Event"} classes={styles.sectionHeader}/>
            <EmployerScroller
        ...
        <Header name={"At Today's Event"} classes={styles.sectionHeader}/>
        <EmployerScroller
          style={{
        ...
        />
        <Header name={"Not Here"} classes={styles.sectionHeader}/>
        <EmployerScroller
          style={{
